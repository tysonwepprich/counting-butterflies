...
```{r params}
# parameters
nsite <- c(10, 25, 50, 100) # up to 140 OH sites
nyear <- c(5, 10, 20) # up to 35 years in Daymet data
nsurv <- 30
...
params <- list(nsite = nsite, nyear = nyear, nsurv = nsurv, surv_missing = surv_missing, ngen = ngen, gen_size = gen_size, peak_sd = peak_sd, death_rate = death_rate, negbin_mu = negbin_mu, negbin_disp = negbin_disp, detprob_b0 = detprob_b0, detprob_b1 = detprob_b1, detprob_b2 = detprob_b2)
